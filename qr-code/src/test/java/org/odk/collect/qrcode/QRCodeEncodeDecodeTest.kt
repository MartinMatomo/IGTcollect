...
class QRCodeEncodeDecodeTest {
    ...
    @Test
    fun `Decoding a QR code that is a screenshot from IGT Collect does not throw any exception`() {
    ...
    @Test
    fun `Decoding a QR code that is shared via IGT Collect does not throw any exception`() {
